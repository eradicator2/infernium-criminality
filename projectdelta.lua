...
local v21 = library();
local v22 = v21:CreateWindow(v12.GUI.GUIToggleKey, 'Infernium');
...
v32:CreateCoppyText('Made By Voltrivax');
v32:CreateCoppyText('https://discord.gg/25ms - Click Me');
